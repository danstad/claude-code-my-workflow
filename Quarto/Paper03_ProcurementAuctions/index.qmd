...
<div class="id-diagram">
  ...
  <div class="id-firm-row">
    <div class="id-firm-box id-type0">
      ...
      <div class="id-firm-sub">Win contracts only through open competitive auctions.<br>Never selected by government discretion.</div>
    </div>
  ...
  <div class="id-obs-row">
    ...
    <div class="id-obs-cell">
      <span class="id-tag yes">✓ Bids in public auctions — observable</span>
      <span class="id-tag no">✗ Costs under I3P / direct allocation — not observable</span>
    </div>
  </div>
  ...
  <div class="id-center-step">
    ...
    <div class="id-step-formula">
      ...
      &nbsp;&nbsp; (pseudo-cost recovered from each bid)
    </div>
  </div>
