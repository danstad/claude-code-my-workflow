...
# Use the same file as the paper (data_G_conditional_diri3p.csv)
df = pd.read_csv(DATA_PATH + "data_G_conditional_diri3p.csv")
...
# No interpolation needed — the pre-computed Julia kernel estimates are already dense
...
| Sewage work dummy | −9.8 pp | More complex projects are more likely to go to public auction |
