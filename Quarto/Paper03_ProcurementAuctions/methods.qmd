...
Once the frontier parameters are estimated, firm-level efficiency is recovered via the conditional mean of $\eta_i$ given the composite residual:
...
This is not the true inefficiency but the best prediction of it given the observable composite error.
:::
