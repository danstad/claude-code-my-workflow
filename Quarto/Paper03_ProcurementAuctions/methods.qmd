...
$$\hat{G}_1(b \mid \mathbf{z}, n_1, n_0) = \frac{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} \frac{1}{n_1}\sum_{p=1}^{n_{1\ell}} \mathbf{1}(b_{1p\ell} \leq b)\; K_G\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zG}}\right)}{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} K_z\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zG}}\right)}, \qquad \hat{G}_0(b \mid \mathbf{z}, n_1, n_0) = \frac{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} \frac{1}{n_0}\sum_{q=1}^{n_{0\ell}} \mathbf{1}(b_{0q\ell} \leq b)\; K_G\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zG}}\right)}{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} K_z\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zG}}\right)}$$

The corresponding bid densities are:

$$\hat{g}_1(b \mid \mathbf{z}, n_1, n_0) = \frac{\dfrac{1}{h_{1g}}\displaystyle\sum_{\ell=1}^{L} \frac{1}{n_1}\sum_{p=1}^{n_{1\ell}} K_g\!\!\left(\dfrac{b - b_{1p\ell}}{h_{1g}},\; \dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zg}}\right)}{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} K_z\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zg}}\right)}, \qquad \hat{g}_0(b \mid \mathbf{z}, n_1, n_0) = \frac{\dfrac{1}{h_{0g}}\displaystyle\sum_{\ell=1}^{L} \frac{1}{n_0}\sum_{q=1}^{n_{0\ell}} K_g\!\!\left(\dfrac{b - b_{0q\ell}}{h_{0g}},\; \dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zg}}\right)}{\displaystyle\sum_{\substack{\ell=1 \\ n_{1\ell}=n_1,\, n_{0\ell}=n_0}}^{L} K_z\!\!\left(\dfrac{\mathbf{z}-\mathbf{z}_\ell}{h_{zg}}\right)}$$
